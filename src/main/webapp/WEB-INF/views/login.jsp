    ...
    <body class="bg-dark" style="background-image: url(resources/public/img/16.jpg);">
        ...
        <div class="container">
            <div class="card card-login mx-auto mt-5">
                <div class="card-header" style="background: #ff253a; text-align: center;"><strong>Login</strong></div>
                <div class="card-body">
                    <form action="perform_login" method="post">
                        ...
                        <input type="submit" class="btn btn-primary btn-block" value="Login"  style="background: #ff253a;"></input>
                        <a class="btn btn-primary btn-block" href="<%=request.getContextPath() %>" style="background: #ff253a;">Home</a>
                    </form>

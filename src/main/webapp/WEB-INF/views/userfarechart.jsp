<%-- 
    Document   : userfarechart
    Created on : Jun 22, 2019, 8:54:34 PM
    Author     : acer
--%>
...
<!--                                    <th>Day Off</th>-->
                                ...
                                <tr ng-repeat="fare in traininflist">
...
<!--                                                <td><a href="editingfarechart?getfarechartid={{tinfo.trainid}}"><button id="editbuttons" type="submit" class="btn">View</button></a>-->

<td><a href="#" ><button id="view" type="submit" class="btn btn-success" ><strong>Auto Selection</strong></button></a>
